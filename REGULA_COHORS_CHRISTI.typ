#set document(title: "Regula Cohors Christi", author: "Paweł Placzyński")
#set text(lang: "pl")
#set heading(numbering: "1.")
#let bible(pl, gr, address) = quote(block: true, attribution: address,
grid(columns: (1fr, 1fr), row-gutter: 0.5em, pl, gr))
#show "Cohors Christi": smallcaps[Cohors Christi]
#show "Itinerarium": emph[Itinerarium]
#show "Contubernium": emph[Contubernium]
#show "Servi": emph[Servi]

= Regula Cohors Christi
...
#bible(
  ...
  [μένετε ἐν τῇ ἀγάπῃ τῇ ἐμῇ·],
  [J 15,9]
)

=== Nauka - słuchanie Chrystusa
...
=== Świadectwo - kroczenie za Chrystusem
...
== Modlitwa codzienna Cohors Christi
...
Zaleca się także codzienny rachunek sumienia.
...
Każde Contubernium prowadzi jeden _Servus_ lub dwóch Servi, którzy:
...
Metodyka prowadzenia formacji powinna pozwalać na przerwanie i wznowienie
formacji w dowolnym momencie.  Program powinien być elastyczny, dostosowany do
...
_Contubernia_ powinny korzystać z pomocy kapłanów, którzy:
...
Program formacji powinien być elastyczny i dostosowany do indywidualnych potrzeb
Contubernium.
...
*Servus* powinien zadbać o to, by temat był zgodny z nauką Kościoła i odpowiadał
na aktualne potrzeby i problemy świata.  Tematyka i cele formacji powinny być
dostosowane do potrzeb Contubernium i jego członków.

Objętość materiałów Itinerarium powinna być dostosowana do możliwości członków
Contubernium.  Należy skupić się na konkretach, nie na ogólnikach, by objętość materiału była ograniczona i możliwa do przetworzenia w danym czasie, a także by nie zniechęcała do pracy.  Nie może on zakłócać obowiązków stanu.

==== Studia

Po spotkaniu inicjującym następuje cykl studiów, który składa się z czterech etapów.

Studia przebiegają indywidualnie, a ich celem jest pogłębienie wiedzy na zadany
temat przewodni.  Każdy członek Contubernium, narzucając sobie swoje tempo pracy, powinien poświęcić na nie odpowiednią ilość czasu, wedle własnego rozeznania, możliwości i umiejętności.  Wskazana jest rzetelność i systematyczność.  Studia powinny być prowadzone w duchu modlitwy i pokory, zawierzenia Bogu i Jego woli.

Efektem pobocznym studiów powinno być stworzenie bazy wiedzy, która będzie
podstawą pracy apologetycznej.  Baza wiedzy powinna być tworzona w formie
osobistych notatek.  Preferencyjnie, notatki tworzone są metodą Zettelkasten.
Każdy członek Contubernium może jednak wybrać swoją metodę - ważne, by była ona
spójna i możliwa do przetworzenia w przyszłości - z własnej bazy wiedzy
członkowie Contubernium będą korzystać w codzienności życia: tam gdzie potrzebna będzie obrona wiary, argumentacja, czy świadectwo.
...
== Dlaczego Reguła stosuje język militarny?
...
== Dlaczego patronami Cohors Christi są Najświętsza Maryja Panna, św. Michał Archanioł, św. Józef, św. Benedykt i św. Tomasz z Akwinu?
...
== Jak treść modlitwy codziennej odnosi się do działalności i ducha Reguły?
...
== Dlaczego skupiamy się na apologetyce?
...
Wybór apologetyki ma na celu skuteczną obronę oraz szerzenie prawdy wiary w warunkach współczesnych wyzwań kulturowych, ideologicznych i społecznych, a także zapewnia chrześcijanom narzędzia do intelektualnej i duchowej obrony przed błędami współczesności.
...
== Czy istnieje balans w działalności Contubernium w obrębie filarów Reguły?
...
== Dlaczego Reguła jest tak elastyczna, a nie jest regułą zakonną?
...
== Czemu Reguła kładzie nacisk na obowiązki stanu?
...
Jest to szczególnie cenne dla osób, które mimo zaangażowania zawodowego czy rodzinnego, pragną zbudować solidny fundament duchowy, intelektualny i apologetyczny, zdolny do skutecznego świadectwa w świecie, często obojętnym lub wręcz nieprzyjaznym wobec chrześcijaństwa.

== Czy Reguła nie jest redundantna? Czy nie ma już innych podobnych formacji katolickich?
...
== Jak oceniać postępy w formacji, aby członkowie czuli, że wzrastają w wierze i poznaniu?
...
== Czego należy oczekiwać od członków Contubernium? Jakich ludzi werbować? Kto nie nadaje się do takiej formacji?
...
== Czy i jak Reguła Cohors Christi nawiązuje do Reguły Benedyktyńskiej?
...
== Jaka powinna być strategia kontaktu z kapłanami w początkowych etapach?
...
=== Prośba o błogosławieństwo lub opinię
...
=== Otwartość na konsultację i współpracę
...
== Jak Cohors Christi planuje zrównoważyć duchowość i formację intelektualną?
